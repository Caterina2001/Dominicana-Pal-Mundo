        ...
        <div class="owl-banner owl-carousel owl-loaded owl-drag">
          <div class="item">
            ...
            <div class="item-content">
              <div class="main-content">
                <div class="meta-category">
                  <span><h3>Punta Cana</h3></span>
                </div>
                <a href="post-details-hoyo.html"><h4>Hoyo Claro</h4></a>
                <ul class="post-info">
                  <li><a href="hotel-hoyo.html">Hoteles</a></li>
          ...
          <div class="item">
            ...
            <div class="item-content">
              <div class="main-content">
                <div class="meta-category">
                  <span><h3>Pedernales</h3></span>
                </div>
                <a href="post-details.html"><h4>Trudille</h4></a>
                <ul class="post-info">
          ...
          <div class="item">
            ...
            <div class="item-content">
              <div class="main-content">
                ...
                <a href="post-details.html"><h4>Cayo Levantado</h4></a>
                <ul class="post-info">
                  <li><a href="#">Hoteles</a></li>
                  <li><a href="#">Experiencias</a></li>
                  <li><a href="#">Restaurantes</a></li>
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="main-content">
              <div class="row">
                <div class="col-lg-8">
                  <span>Dominicana pal mundo</span>
                  <h4>Disponible ahora la aplicación para movil</h4>
                </div>
                <div class="col-lg-4">
